...
sizes_gen = [10,20,50,100,200,300,500]

for size_gen in sizes_gen:
	
	FILE = open("results-size_gen_"+str(size_gen)+"-best.txt",'w')
	filename = "results-size_gen_"+str(size_gen)+".csv"
...
for size_gen in sizes_gen:
	...
	FILE = open("results-size_gen_x_roleta"+str(size_gen)+"-best.txt",'w')
	filename = "results-size_gen_x_roleta"+str(size_gen)+".csv"
	excelWriter = csv.writer(open(filename, 'wb'))
	excelWriter.writerow(('Melhor tempo real: ', str(bestRealFitness) ))
	FILE.write("Real Curve points:\n"+str(points)+"\nFitness: "+str(bestRealFitness)+"\n\n")
...
for size_gen in sizes_gen:
	...
	FILE = open("results-size_gen_y_roleta"+str(size_gen)+"-best.txt",'w')
	filename = "results-size_gen_y_roleta"+str(size_gen)+".csv"
	excelWriter = csv.writer(open(filename, 'wb'))
	excelWriter.writerow(('Melhor tempo real: ', str(bestRealFitness) ))
	FILE.write("Real Curve points:\n"+str(points)+"\nFitness: "+str(bestRealFitness)+"\n\n")
...
for size_gen in sizes_gen:
	...
	FILE = open("results-size_gen_y_torneio"+str(size_gen)+"-best.txt",'w')
	filename = "results-size_gen_y_torneio"+str(size_gen)+".csv"
	excelWriter = csv.writer(open(filename, 'wb'))
	excelWriter.writerow(('Melhor tempo real: ', str(bestRealFitness) ))
	FILE.write("Real Curve points:\n"+str(points)+"\nFitness: "+str(bestRealFitness)+"\n\n")
